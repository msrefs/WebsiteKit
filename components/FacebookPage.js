...
const FacebookPage = () => {
  ...
  return <div className="shadow-md hover:shadow-xl dark:text-gray-300 border dark:border-black rounded-[24px] px-2 py-4 bg-white dark:bg-hexo-black-gray lg:duration-100 justify-center">
