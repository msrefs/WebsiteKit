        ...
        <div className='flex items-start mb-6'>
          <div className='flex items-center h-5'>
            <input
              ...
              type='checkbox'
              value=''
              className='w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-green-300 dark:ring-offset-gray-800'
              required
            />
          </div>
          <label
            ...
            <Link
              href='/terms-of-use'
              className='text-green-300 hover:underline dark:text-blue-500'>
              服务协议
            </Link>
            .
          </label>
