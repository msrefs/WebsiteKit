...
export default function DashboardItemHome() {
  return (
    <div className='w-full mx-auto'>
      {/* 提示消息 */}
      <div
        className='p-4 mb-4 text-xl font-bold text-green-800 rounded-full bg-green-50 dark:bg-gray-800 dark:text-green-400'
        role='alert'>
      ...
      {/* 背景动画块 */}
      <div className='relative w-full h-64 rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 overflow-hidden'>
