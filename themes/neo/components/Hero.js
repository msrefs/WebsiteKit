  ...
  return (
    <div className='w-full select-none mb-8'>
      ...
      <div className='max-w-[86rem] w-full mx-auto px-5'>
        ...
        `}>
          {/* 内容区域 */}
          <div className='z-10 flex flex-col absolute top-12 left-12 max-w-lg animate-slide-up'>
      ...
      <div className='md:hidden w-full px-4'>
        ...
        `}>
          ...
          <div className="absolute right-0 top-0 h-full w-1/2 overflow-hidden">
            ...
            <div className="absolute -right-12 top-1/4 w-48 h-48 rounded-full bg-[#00e599] opacity-10 blur-[70px] animate-fade-in" style={{ animationDelay: '0.3s' }}></div>
          </div>
        </div>
      </div>
    </div>
