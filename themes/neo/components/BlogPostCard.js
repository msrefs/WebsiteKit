      ...
      <div
        ...
        <div
          ...
          <header>
            ...
            {post?.category && (
              <div
                className={`flex mb-1 items-center ${showPreview ? 'justify-center' : 'justify-start'} hidden md:block flex-wrap dark:text-gray-300 text-gray-600 hover:text-emerald-400 dark:hover:text-emerald-400`}>
                <Link
                  passHref
