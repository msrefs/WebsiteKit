      ...
      <div className='text-center space-y-3'>
        ...
        <div className='flex mx-4'>
          ...
          <div
            ...
            className='px-3 whitespace-nowrap cursor-pointer items-center justify-center py-2 bg-emerald-400 hover:bg-emerald-400 text-white rounded-r duration-300'>
