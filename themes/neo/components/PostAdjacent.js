  ...
  return (
    <div id='article-end'>
      ...
      <div
        ...
        <Link
          href={`/${next.slug}`}
          className='text-sm block p-4 w-72 h-28 cursor-pointer drop-shadow-xl duration transition-all dark:bg-[#1e1e1e] border dark:border-gray-600 bg-white dark:text-gray-300 dark:hover:text-green-400 hover:font-bold hover:text-green-400 rounded-[24px]'>
