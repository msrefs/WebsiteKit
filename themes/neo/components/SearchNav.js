                ...
                {categoryOptions?.map(category => {
                  return (
                      <Link
                          ...
                          <div
                              className={
                                  ' duration-300 dark:hover:text-white dark:text-gray-200 rounded-[24px] px-3 cursor-pointer py-1 hover:bg-green-400 dark:hover:bg-green-400 hover:text-white'
                              }
                          >
